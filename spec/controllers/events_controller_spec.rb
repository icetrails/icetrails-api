...
describe EventsController do
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved event as @event" do
        ...
        post :create, {:event => { "user_id" => user.to_param }}, valid_session
        assigns(:event).should be_a_new(Event)
      end
  ...
  #       Event.any_instance.should_receive(:update).with({ "user_id" => user.to_param })
  #       put :update, {:id => event.to_param, :event => { "user_id" => user.to_param }}, valid_session
  #     end
  ...
  #       # Trigger the behavior that occurs when invalid params are submitted
  #       Event.any_instance.stub(:save).and_return(false)
  #       put :update, {:id => event.to_param, :event => { "user_id" => -1 }}, valid_session
  #       assigns(:event).should eq(event)
  #     end
