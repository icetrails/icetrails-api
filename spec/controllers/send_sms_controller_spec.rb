...
describe SendSmsController do
  ...
  let(:destination) { '5106427453' }
  let(:valid_attributes) { { message: message, destination: destination } }
  ...
  describe "POST create" do
    describe "with valid params" do
      before(:each) do
        SendSMS.stub(:send_message)
      end
      it "calls send_message with the params" do
        SendSMS.should_receive(:send_message).with(message, destination)
